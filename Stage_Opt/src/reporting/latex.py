...
@article{de_ascent_2021,
  ...
  url = {https://onlinelibrary.wiley.com/doi/10.1155/2021/6647440}
        ...
        # Add citations to the LaTeX report
        report_content = report_content.replace(r"\section{Optimization Methods}", r"\section{Optimization Methods}\citep{pso_ascent_2013, evolutionary_rocket_2022, pso_micro_launch_2012, de_ascent_2021}")
